...
export const MOCK_PLACES: MockPlace[] = [
  ...
  },
  {
    ...
    badges: [{ label: '음식' }, { label: '4.16', status: 'neutral' }],
  },
  {
    id: 'aewol-cafe',
    title: '애월 카페거리',
  ...
  },
  {
    ...
    badges: [{ label: '역사' }, { label: '4.5', status: 'neutral' }],
  },
  {
    id: 'aewol-stay',
    title: '애월 바다뷰 숙소',
    ...
    badges: [{ label: '숙박' }, { label: '4.6', status: 'neutral' }],
  },
  {
    id: 'hallim-park',
    title: '한림공원',
  ...
  },
  {
    ...
    badges: [{ label: '음식' }, { label: '4.6', status: 'neutral' }],
  },
  {
    id: 'eorimok-trail',
    title: '어리목 탐방로',
